...
navbarPage("Hydro Explorer", id="nav", theme = shinytheme("sandstone"),
  ...
  tabPanel("Tools",
           ...
           p(tags$b("Break day:", style="color:CadetBlue"),  "Customize x-axis by selecting different break days. Currently available selection are 1.October (start hydrological year in Switzerland), 1.November (start hydrological year in Germany), 1.December and 1.January."),
           p(tags$b("Time frame:", style="color:CadetBlue"), "Select start and end year of time frame displayed."),
           ...
           tags$b("Interactive options"),
           p(tags$b("Break day:", style="color:CadetBlue"),  "Customize x-axis by selecting different break days. Currently available selection are 1.October (start hydrological year in Switzerland), 1.November (start hydrological year in Germany), 1.December and 1.January."),
           p(tags$b("Time frame 1: ", style="color:CadetBlue"), "Select start and end year of time frame 1 (blue line)."),
           p(tags$b("Time frame 2: ", style="color:CadetBlue"), "Select start and end year of time frame 2 (red line)."),
           p(tags$b("Window width moving averages: ", style="color:CadetBlue"), "Prior the calculation of mean annual cycle a moving average filter can be moved over the time series."),
           ...
           tags$b("Interactive options"),
           p(tags$b("Break day:", style="color:CadetBlue"),  "Select start day of the year considered. Currently available selection are 1.October (start hydrological year in Switzerland), 1.November (start hydrological year in Germany), 1.December and 1.January."),
           p(tags$b("Time frame:", style="color:CadetBlue"), "Select start and end year of time frame investigated."),
           ...
           tags$b("Interactive options"),
           p(tags$b("Variable: ", style="color:CadetBlue"), "Select annual maxima characteristic to be investigated: 'Day of the year' or 'Magnitude'. The option 'Monthly Maxima' returns trends of magnitudes of monthly maxima."),
           p(tags$b("Time frame:", style="color:CadetBlue"), "Select start and end year of time frame investigated."),
           p(tags$b("Break day: ", style="color:CadetBlue"),  "Select start day of years. Example: Selecting day 305 means that years are from 1.Nov - 30.Oct. If variable is 'Monthly Maxima' or individual months are selected (see next option), break day is automatically set to 1.Jan."),
           p(tags$b("Months: ", style="color:CadetBlue"),  "Only selected months are taken into account to determine maxima (1 to 12 = January to December). Example: Selecting 3 to 6 means that only values recorded from March to June are considered to determine annual maxima."),
           ...
           tags$b("Interactive options"),
           p(tags$b("Plot type:", style="color:CadetBlue"),  "The option 'Line plot' enables the comparison of quantiles of a selected probability level (see option 'Probability'). The 'Image plot' shows the difference between quantile values of different time windows for all probability levels."),
           p(tags$b("Time frame 1: ", style="color:CadetBlue"), "Select start and end year of time frame 1 (blue line)."),
           p(tags$b("Time frame 2: ", style="color:CadetBlue"), "Select start and end year of time frame 2 (red line)."),
           p(tags$b("Probability", style="color:CadetBlue"), "Select which quantile to compare (only relevant for 'Line plot')"),
